        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageLogo = table.Column<string>(type: "varchar", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ImageCar1 = table.Column<string>(type: "varchar", nullable: true),
                    ImageCar2 = table.Column<string>(type: "varchar", nullable: true),
                    ImageCar3 = table.Column<string>(type: "varchar", nullable: true),
                    ImageCar4 = table.Column<string>(type: "varchar", nullable: true),
                    ImageCar5 = table.Column<string>(type: "varchar", nullable: true),
                    CarDetailId = table.Column<int>(type: "int", nullable: false),
                    CreatedDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    ModifiedDate = table.Column<DateTime>(type: "datetime", nullable: false),
                    Version = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
